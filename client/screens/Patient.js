...
export const Patient = ({navigation}) => {
    ...
    const changeAvatar5 = () => { setSelAvatar5(true); setAvatarState(5), console.log(avatarState)}
    const changeAvatar6 = () => { setSelAvatar6(true); setAvatarState(6), console.log(avatarState)}
    const changeAvatar7 = () => { setSelAvatar7(true); setAvatarState(7), console.log(avatarState)}
    const changeAvatar8 = () => { setSelAvatar8(true); setAvatarState(8), console.log(avatarState)}
